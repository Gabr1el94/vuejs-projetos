  ...
  <div class="ui centered card">
    <div class="content" v-show="!ehEditavel">
      ...
      <div class="extra content">
        <span class="right floated edit icon" v-show="!todo.concluido" v-on:click="abrirForm">
          <i class="edit icon"></i>
        </span>
        <span class="right floated trash icon" v-on:click="deleteTodo(todo)">
          <i class="trash icon"></i>
        </span>
        <span class="right floated refresh icon" v-show="todo.concluido" v-on:click="pendenteTodo(todo)">
